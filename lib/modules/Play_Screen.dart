...
class _playPageState extends State<playPage> {
                ...
                IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => pageNamefor2player(),
                        ));
                  },
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(
                            child: Text(
                              '${X_o ? 'X' : 'O'}',
                              style: mystyle.copyWith(fontSize: 15),
                            )),
                      ),
                    ],
                  ),
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[1] == '') {
                              istrue
                                  ? display[1] = istrue ? 'x' : autoplay()
                                  : display[1] = !istrue ? autoplay() : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[2] == '') {
                              istrue
                                  ? display[2] = istrue ? 'x' : 'o'
                                  : display[2] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[3] == '') {
                              istrue
                                  ? display[3] = istrue ? 'x' : 'o'
                                  : display[3] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[4] == '') {
                              istrue
                                  ? display[4] = istrue ? 'x' : 'o'
                                  : display[4] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[5] == '') {
                              istrue
                                  ? display[5] = istrue ? 'x' : 'o'
                                  : display[5] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[6] == '') {
                              istrue
                                  ? display[6] = istrue ? 'x' : 'o'
                                  : display[6] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[7] == '') {
                              istrue
                                  ? display[7] = istrue ? 'x' : 'o'
                                  : display[7] = !istrue ? 'o' : 'x';
                              turn = !turn;
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            if (display[8] == '') {
                              istrue
                                  ? display[8] = istrue ? 'x' : 'o'
                                  : display[8] = !istrue ? 'o' : 'x';
                              turn = !turn;
            ...
            Expanded(
              child: Column(
                children: [
                  Center(
                    child: Text(
                      'Turn: ${turn ? widget.player1 : widget.player2}',
                      style: GoogleFonts.pressStart2p(
                        fontSize: 15,
                        letterSpacing: 1,
                        color: Colors.white,
  ...
  String autoplay() {
    for (var i = 1; i < 9; i++) {
      if (display[i].isNotEmpty) emptyCells.add(i);
    }
        ...
        return AlertDialog(
          title: Row(
            children: [
              Text('WINNER is  ' + winner,
                  style: mystyle2.copyWith(fontSize: 22)),
              SizedBox(
                width: 12,
              ),
              Image(
          ...
          actions: [
            MaterialButton(
              ...
              child: Text(
                'PLAY Again !',
                style: mystyle2.copyWith(fontSize: 20),
              ),
            )
          ],
        );
